...
class SettingsRepositoryImpl @Inject constructor(
    ...
    private val DEFAULT_REMINDER = "Halo [NamaAnggota], sekadar mengingatkan untuk iuran arisan kelompok [NamaKelompok]. Sisa tagihan Anda adalah [SisaTagihan]. Terima kasih!"
    ...
    private val DEFAULT_WIN = "Selamat kepada [NamaAnggota] telah memenangkan kocokan arisan kelompok [NamaKelompok] dengan total tarikan [NominalTarikan]! 🎉"
